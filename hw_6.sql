...
CREATE PROCEDURE  procedure1(IN num INT) 
BEGIN
...
/*Создайте хранимую функцию hello(), которая будет возвращать приветствие, в зависимости от текущего времени суток. С 6:00 до 12:00 функция должна возвращать фразу "Доброе утро", с 12:00 до 18:00 функция должна возвращать фразу "Добрый день", 
с 18:00 до 00:00 — "Добрый вечер", с 00:00 до 6:00 — "Доброй ночи".*/

DELIMITER //
CREATE FUNCTION hello1 (time_current TIME) 
	RETURNS VARCHAR(50)
    DETERMINISTIC
BEGIN
DECLARE hello_text VARCHAR (50);
SELECT CASE 
	WHEN time_current >= '06:00:00' AND  time_current < '12:00:00' THEN 'Доброе утро'
    WHEN time_current >= '12:00:00' AND  time_current < '18:00:00' THEN 'Добрый день'
	WHEN time_current>= '18:00:00' AND  time_current < '00:00:00' THEN 'Добрый вечер'
	ELSE 'Доброй ночи'
END INTO hello_text;
RETURN hello_text;
END //
